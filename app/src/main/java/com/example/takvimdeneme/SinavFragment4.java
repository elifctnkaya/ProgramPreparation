...
public class SinavFragment4 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.sinavfragment4, container, false);
        ...
        for (SinavTable e : gelenler) {
            ...
            if (gunn.contentEquals("PERŞEMBE")) {
                switch (saat) {
                    case "08.00":
        ...
        buton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gecis(new SinavFragment3());
            }
        });
        buton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gecis(new SinavFragment5());
            }
        });
