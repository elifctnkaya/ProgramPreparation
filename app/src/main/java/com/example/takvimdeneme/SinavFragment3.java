...
public class SinavFragment3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.sinavfragment3, container, false);
        ...
        for (SinavTable e : gelenler) {
            ...
            if (gunn.contentEquals("ÇARŞAMBA")) {
                switch (saat) {
                    case "08.00":
